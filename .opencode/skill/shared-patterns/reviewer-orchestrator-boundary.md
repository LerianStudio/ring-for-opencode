...
┌─────────────────────────────────────────────────────────────────┐
│                        ORCHESTRATOR                              │
│  (dev-cycle, user, or workflow coordinator)                     │
│                                                                  │
...
See [shared-patterns/reviewer-orchestrator-boundary.md](../shared-patterns/reviewer-orchestrator-boundary.md) for:
