...
| Go | API, Worker, Batch, CLI | - | `backend-engineer-golang` |
| TypeScript | API, Worker | - | `backend-engineer-typescript` |
| TypeScript | Frontend, BFF | No product-designer outputs | `frontend-bff-engineer-typescript` |
| TypeScript | Frontend | ux-criteria.md exists | `ui-engineer` |
| React/CSS | Design, Styling | - | `frontend-designer` |

**ui-engineer Selection:**
When implementing frontend features with product-designer outputs (ux-criteria.md, user-flows.md, wireframes/), use `ui-engineer` instead of `frontend-bff-engineer-typescript`. The ui-engineer specializes in translating design specifications into production code while ensuring all UX criteria are satisfied.
