...
metadata:
  trigger: "Staying in current session, tasks are independent, want continuous progress"
  skip_when: "Need human review between tasks, tasks are tightly coupled, plan needs revision"
