...
See [shared-patterns/standards-compliance-detection.md](standards-compliance-detection.md) for:
...
- Sections to check: See [standards-coverage-table.md](standards-coverage-table.md)
