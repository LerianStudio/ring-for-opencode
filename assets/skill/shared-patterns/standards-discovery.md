...
See [shared-patterns/standards-discovery.md](standards-discovery.md) for complete workflow.
...
See [shared-patterns/standards-discovery.md](standards-discovery.md) for:
