...
research_modes:
  greenfield:
    ...
    primary_agents: [best-practices-researcher, framework-docs-researcher, product-designer]
  ...
  modification:
    ...
    secondary_agents: [product-designer]
...
|-------|--------------|------|
| `repo-research-analyst` | Codebase patterns for [feature]. Search docs/solutions/ knowledge base. Return file:line references. | PRIMARY in modification |
| `best-practices-researcher` | External best practices for [feature]. Use Context7 + WebSearch. Return URLs. | PRIMARY in greenfield |
| `framework-docs-researcher` | Tech stack docs for [feature]. Detect versions from manifests. Use Context7. Return version constraints. | PRIMARY in integration |
| `product-designer` | User problem validation, personas, competitive UX analysis, design constraints for [feature]. Mode: `ux-research`. | PRIMARY in greenfield, SECONDARY in others |
...
- **repo-research-analyst:** Run ONCE per module path
